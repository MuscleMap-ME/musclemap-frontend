...
\texttt{GET} & \texttt{/admin/feedback} & admin-feedback \\
\texttt{GET} & \texttt{/admin/feedback/:id} & admin-feedback \\
\texttt{PATCH} & \texttt{/admin/feedback/:id} & admin-feedback \\
\texttt{POST} & \texttt{/admin/feedback/:id/cancel-autofix} & admin-feedback \\
\texttt{POST} & \texttt{/admin/feedback/:id/confirm-bug} & admin-feedback \\
\texttt{POST} & \texttt{/admin/feedback/:id/respond} & admin-feedback \\
\texttt{GET} & \texttt{/admin/feedback/recent-activity} & admin-feedback \\
\texttt{GET} & \texttt{/admin/feedback/stats} & admin-feedback \\
\bottomrule
