import{j as e}from"./react-vendor-D1NxaRNd.js";import{M as r}from"./markdown-vendor-Bj-3Lb1i.js";import"./leaflet-vendor-DZbo3Ov0.js";const i=`# MuscleMap Privacy Policy
...
`;function l(){return e.jsx("div",{className:"min-h-screen bg-mesh-void",children:e.jsxs("div",{className:"max-w-4xl mx-auto px-6 py-16",children:[e.jsx("div",{className:"mb-12",children:e.jsxs("a",{href:"/",className:"inline-flex items-center gap-2 text-text-secondary hover:text-text-primary transition-colors mb-8",children:[e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M19 12H5M12 19l-7-7 7-7"})}),"Back to MuscleMap"]})}),e.jsx("article",{className:"card-glass p-8 md:p-12",children:e.jsx("div",{className:"prose prose-invert prose-lg max-w-none",children:e.jsx(r,{components:{h1:({children:t})=>e.jsx("h1",{className:"text-4xl font-bold text-text-primary mb-8 bg-gradient-to-r from-brand-blue-400 to-brand-pulse-400 bg-clip-text text-transparent",children:t}),h2:({children:t})=>e.jsx("h2",{className:"text-2xl font-semibold text-text-primary mt-10 mb-4 border-b border-border-subtle pb-2",children:t}),h3:({children:t})=>e.jsx("h3",{className:"text-xl font-medium text-text-primary mt-6 mb-3",children:t}),p:({children:t})=>e.jsx("p",{className:"text-text-secondary leading-relaxed mb-4",children:t}),ul:({children:t})=>e.jsx("ul",{className:"list-disc list-inside text-text-secondary space-y-2 mb-4 ml-4",children:t}),li:({children:t})=>e.jsx("li",{className:"text-text-secondary",children:t}),strong:({children:t})=>e.jsx("strong",{className:"text-text-primary font-semibold",children:t}),a:({href:t,children:a})=>e.jsx("a",{href:t,className:"text-brand-blue-400 hover:text-brand-blue-300 underline underline-offset-2",target:"_blank",rel:"noopener noreferrer",children:a})},children:i})})}),e.jsx("footer",{className:"mt-12 text-center text-text-tertiary text-sm",children:e.jsxs("p",{children:["© ",new Date().getFullYear()," MuscleMap. All rights reserved."]})})]})})}export{l as default};
